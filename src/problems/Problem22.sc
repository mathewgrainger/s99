...
def range(i : Int, j : Int) = (i to j).toList

range(4,9)

/*

I guess range is new?

I was being a bit lazy with this one. Didn't attempt the recursive solution - was unaware of unfoldr as an option
